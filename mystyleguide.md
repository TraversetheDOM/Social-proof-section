...
--dar-grayish-magenta: hsl(303, 10%, 53%);
```
...
--fw-500: 500;
--fw-700: 700;
--fs-1: clamp(0.56rem, calc(0.50rem + 0.16vw), 0.74rem);
--fs-2 clamp(0.62rem, calc(0.56rem + 0.18vw), 0.83rem);
--fs-3: clamp(0.70rem, calc(0.64rem + 0.21vw), 0.93rem);
--fs-4: clamp(0.78rem, calc(0.72rem + 0.23vw), 1.06rem);
--fs-5: clamp(0.9rem, calc(0.80rem + 0.26vw), 1.18rem);
--fs-6: clamp(0.99rem, calc(0.91rem + 0.30vw), 1.33rem);
--fs-7: clamp(1.12rem, calc(1.02rem + 0.33vw), 1.50rem);
--fs-8: clamp(1.26rem, calc(1.15rem + 0.37vw), 1.68rem);
--fs-9: clamp(1.42rem, calc(1.30rem + 0.42vw), 1.90rem);
--fs-10: clamp(1.60rem, calc(1.46rem + 0.47vw), 2.13rem);
--fs-11: clamp(1.81rem, calc(1.63rem + 0.53vw), 2.4rem);
--fs-12: clamp(2.03rem, calc(1.84rem + 0.60vw), 2.70rem);
...
--fs-17: clamp(4.11rem, calc(3.73rem + 1.21vw), 5.47rem);
--fs-18: clamp(4.62rem, calc(4.19rem + 1.37vw), 6.16rem);
--fs-19: clamp(5.2rem, calc(4.72rem + 1.54vw), 6.93rem);
--fs-fs-20: clamp(5.84rem, calc(5.31rem + 1.73vw), 7.79rem);
```
